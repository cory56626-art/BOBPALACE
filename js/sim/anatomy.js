...
export const HUMAN = {
  ...
  parts: {
    'foot.l':     { a: [-0.070, 0.038], b: [0.190, 0.038], r: 0.038, depth: -1, d: 1050 },
    'shin.l':     { a: [0, 0.475], b: [0, 0.085], r: 0.055, depth: -1, d: 1050 },
    'thigh.l':    { a: [0, 0.905], b: [0, 0.495], r: 0.077, depth: -1, d: 1050 },
    'foot.r':     { a: [-0.070, 0.038], b: [0.190, 0.038], r: 0.038, depth: 1, d: 1050 },
...
export const CHIMP = {
  ...
  parts: {
    'foot.l':     { a: [-0.075, 0.036], b: [0.225, 0.036], r: 0.040, depth: -1, d: 1050 },
    'shin.l':     { a: [0, 0.400], b: [0, 0.075], r: 0.058, depth: -1, d: 1080 },
    'thigh.l':    { a: [0, 0.720], b: [0, 0.420], r: 0.082, depth: -1, d: 1080 },
    'foot.r':     { a: [-0.075, 0.036], b: [0.225, 0.036], r: 0.040, depth: 1, d: 1050 },
